...
(() => {
    ...
    console.log(avenger.charAt(1)); //Otra forma de acceder a los métodos de tipo string es realizar un casting de tipo con la palabra reservada as
    ...
    console.log(avenger.toFixed(3)); //Otra forma
